...
#colorjack_square .hexString {
	float:left;
	color:#fff;
	cursor: text;
}

#colorjack_square .hexBox {
...
#colorjack_square .hexClose:hover {
	color:#FFD000;
}
X;

$zDESC=<<<X
Originally was developed for <a href="http://www.colorjack.com/studio/">ColorJack: Studio</a> &mdash; feel free to <a href="{$URL}projects/DHTML_Color_Picker.zip">download the .zip</a><br><br>
Want another color picker? <a href="{$URL}DHTML_Color_Sphere/">Color Sphere</a> or <a href="{$URL}DHTML_Color_Picker_2/">Color Picker v2.0</a><br><br>
